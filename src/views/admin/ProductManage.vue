                ...
                <td class="px-6 py-4 max-w-0">
                  <div class="flex items-center min-w-0">
                    ...
                    <div class="ml-4 min-w-0 flex-1">
                      <div class="text-sm font-medium text-gray-900 truncate" :title="product.nameEn">
                        {{ product.nameEn }}
                      </div>
                      <div class="text-sm text-gray-500 truncate" :title="product.slug">{{ product.slug }}</div>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4 max-w-0">
                  <div class="text-sm text-gray-900 truncate" :title="product.category?.nameEn">
